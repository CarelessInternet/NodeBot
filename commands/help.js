...
module.exports = {
  ...
  async execute(interaction, prefix) {
    ...
    if (arg) {
      ...
      .addFields({
        name: 'Prefix',
        value: `Use the \`${prefix}\` prefix before putting in the command. Custom prefixes aren't available with me, since message content will be [restricted in April 2022](https://support-dev.discord.com/hc/en-us/articles/4404772028055)`
      }, {
        name: 'Support',
