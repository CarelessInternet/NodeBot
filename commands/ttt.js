...
module.exports = {
  ...
  execute(msg) {
    msg.reply('This command is currently not available. The module hasn\'t been updated for discord.js v13 yet and I can\'t be bothered creating tic-tac-toe myself').catch(console.error);
